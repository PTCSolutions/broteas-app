...
*/
export function logicalPropertiesHorizontalSlide(node : Element, {
	delay = 0,
	duration = 400,
	easing = cubicOut,
	direction = 'block'
	...
	const size_value = parseFloat(style.getPropertyValue(`${direction}Size`));
	const padding_start_value = parseFloat(style.getPropertyValue(`padding${capitalized_logical_property}Start`));
	const padding_end_value = parseFloat(style.getPropertyValue(`padding${capitalized_logical_property}End`));
	const margin_start_value = parseFloat(style.getPropertyValue(`margin${capitalized_logical_property}Start`));
	const margin_end_value = parseFloat(style.getPropertyValue(`margin${capitalized_logical_property}End`));
	const border_width_start_value = parseFloat(style.getPropertyValue(`border${capitalized_logical_property}StartWidth`));
	const border_width_end_value = parseFloat(style.getPropertyValue(`border${capitalized_logical_property}EndWidth`));
